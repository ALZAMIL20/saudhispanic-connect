...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-md mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            <span className="text-red-600">Saudi</span>
            <span className="text-yellow-500">Hispanic</span> Connect
          </h1>
          <p className="text-gray-600 mt-2">Únete a nuestra comunidad hispanohablante en Arabia Saudita</p>
        </div>
          ...
          <TabsContent value="register">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="location">Ciudad en Arabia Saudita</Label>
                  <Input id="location" placeholder="Riyadh" />
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox id="terms" />
                  <label
